...
train_data_new <- data[train_index, ]
test_data_new <- data[-train_index, ]
...
test_x_new <- as.data.frame(scale(test_x))
...
confusionMatrix(predictions_new, test_data$Team.Success)
